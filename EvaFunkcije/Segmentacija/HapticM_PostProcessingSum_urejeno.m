...
pot = 'C:\School\Human Robot Interaction\Meritve';
...
no_damp_iterations = 1; % !!!PAZI!!! 3 velja le v primeru, da imamo za vsak objekt vedno 3 razli?ne damping-e
experiments_folder = dir([pot,'/*.mat']);
...
%for subject_no_folder = 1:39
    %for damping_no_folder = 1:no_damp_iterations
        FileName = ['s', num2str(subject_no_folder), '_', num2str(damping_no_folder), '0.mat'];
        FolderName = pot;
        File = fullfile(FolderName, FileName);
        sample = load('C:\School\Human Robot Interaction\Meritve\Lepo poimenovane meritve\meritev1_elastika_2_3.mat'); % Nalo?imo podatke
%         sample.data = data;
        ...
        addpath('C:\School\Human Robot Interaction\Vaje HM 2020\interparc')
        ...
        for repetition_no = 1:data(40,1) % 40 vrstica, 1 stolpec - Number of repetitions
            ...
            % hand_trajectory
            hand_trajectory = [data(2,:)', data(4,:)', data(3,:)'];
%             figure
